...
<body>
	...
	<div class="section1">
        <div class="columna-izquierda">
          <p>Val Consulting es una firma colombiana que presta servicios de Asesoría tributaria, Outsourcing, Auditoría y Consultoría de Normas Internacionales de Información Financiera (NIIF – IFRS) y Servicios especializados de Consultoría, desde hace más de 5 años.</p>
          <a href="nosotros.html" class="enlace-leer-mas">Leer más...</a>
        </div>
        <div class="columna-derecha">
          <iframe src="https://www.youtube.com/embed/-GjScU50mxQ" class="video" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
      </div>
	...
	<!-- Seccion 3 -->
	<div class="container mt-5" id="culturas">
        <div class="row">
            <div class="col-md-12">
                <h2>Culturas y Valores</h2>
                <p>Contenido de la sección Culturas y Valores</p>
            </div>
        </div>
    </div>
